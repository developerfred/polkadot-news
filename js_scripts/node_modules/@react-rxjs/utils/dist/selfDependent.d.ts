 ...
 */
export declare const selfDependent: <T>() => [Observable<T>, () => MonoTypeOperatorFunction<T>];
/**
 * @deprecated renamed to `selfDependent`
 */
export declare const selfDependant: <T>() => [Observable<T>, () => MonoTypeOperatorFunction<T>];
